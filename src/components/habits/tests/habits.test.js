...
describe('Habits', () => {
    ...
    beforeEach(() => {
        ...
        onDelete = jest.fn();
        onReset = jest.fn();
        HabitsComponent = (<Habits habits={habits} onIncrement={onIncrement} onDecrement={onDecrement} onAdd={onAdd} onDelete={onDelete} onReset={onReset} />)
    })
    it('renders', () => {
    ...
    describe('Button Click', () => {
        ...
        it('calls onAdd when clicking the "Add" button', () => {
            ...
            const button = screen.getByText('Add2');
